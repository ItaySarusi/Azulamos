    ...
    <section id="testimonials" className="section-padding bg-gray-50">
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <TestimonialCard 
            quote="הבן שלי תמיד התעניין בתספורות ועיצוב שיער. Pink Barber נתן לו דרך יצרנית לנתב את העניין הזה תוך למידת מיומנויות חשובות. הוא מצפה לשיעור בכל שבוע!"
            name="יעל פ."
          ...
          <TestimonialCard 
            quote="Pink Barber מספקת סביבה תומכת כל כך. הבת שלי הייתה ביישנית בהתחלה, אבל הקהילה שהם בנו עזרה לה לפתח ביטחון עצמי לצד מיומנויות הספרות שלה."
            name="מיכאל כ."
